    ...
    def __init__(self, verbose, seg, output, SGML, edus, feature_sets='FengHirst'):
        ...
        try:
            if self.feature_sets == 'FengHirst':
                ...
                #                                _bin_model_file='struct/hilda/liblinear_bin_model.dat',
                #                                _bin_scale_model_file='struct/hilda/bin_scale',
                #                                _mc_model_file='label/hilda/libsvm_rbf_mc_model.dat',
                #                                _mc_scale_model_file='label/hilda/mc_scale',
