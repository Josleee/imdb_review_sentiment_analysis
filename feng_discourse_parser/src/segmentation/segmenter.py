...
class Segmenter:
    ...
    def __init__(self, _model_path=paths.SEG_MODEL_PATH, _model_file=None, _scale_model_file=None,
        ...
        self.svm_classifier = SVMClassifier(class_type='bin', software='libsvm',
                                            model_path=_model_path, bin_model_file=_model_file,
                                            bin_scale_model_file=_scale_model_file,
                                            output_filter=float,
    ...
    def do_segment(self, text, input_edus=None, parsed_filename=None, heads_filename=None, deps_filename=None):
        ...
        if input_edus:
            edus, edus_intervals_pairs = utils.utils.align_edus_with_syntax_trees(input_edus, lexicalized_trees,
                                                                                  segmented_text,
                                                                                  self.penn_special_chars)
        else:
