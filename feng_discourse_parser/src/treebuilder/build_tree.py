...
class TreeBuilder:
    def __init__(self, _model_path=paths.MODEL_PATH, _bin_model_file=None, _bin_scale_model_file=None,
        ...
        if self.name == 'hilda':
            ...
            self.svm_mc_classifier = SVMClassifier(class_type='mc', software='libsvm',
                                                   model_path=_model_path, mc_model_file=_mc_model_file,
                                                   mc_scale_model_file=_mc_scale_model_file,
            ...
            self.svm_bin_classifier = SVMClassifier(class_type='bin', software='liblinear',
                                                    model_path=_model_path, bin_model_file=_bin_model_file,
                                                    bin_scale_model_file=_bin_scale_model_file,
    ...
    def classify_pair(self, stumps, pair, offsets, i, stumps_mc_scores=None, stumps_bin_scores=None):
        ...
        if self.name == 'FengHirst':
            ...
            (bin_inst, mc_inst) = self.feature_writer.write_instance(None, None, pair, None, self.syntax_trees,
                                                                     self.breaks,
                                                                     offsets[i])
    ...
    def connect_stumps(self, i, (stumps, stumps_mc_scores, stumps_bin_scores, offsets, tree_score)):
        ...
        if i > 0:  # left pair
            ...
            (bin_score, mc_score) = self.classify_pair(stumps, pair, offsets, i - 1, stumps_mc_scores,
                                                       stumps_bin_scores)
